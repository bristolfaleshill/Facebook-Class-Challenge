...
class FacebookProfile {
    ...
    var bio = "Six foot two giraffe from the Lou 🦒❤️"
    var friendCount = 8200000
    let birthday = "August 3rd, 1992"
    var relationshipStatus = "Married"
    var friendList = ["Josh Kushner", "Jimmy Fallon", "Taylor Swift", "Serena Williams", "Kendall Jenner", "Gigi Hadid", "Ashley Graham", "Joan Smalls", "Cara Delevigne"]
...
} //closing bracket fot the facebook profile class

var karlie = FacebookProfile() // creates object called karlie
print(karlie) // prints the object: __lldb_expr_18.FacebookProfile
